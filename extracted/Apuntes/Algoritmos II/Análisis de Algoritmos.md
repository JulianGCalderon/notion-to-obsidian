...
$$
T(N) = O(f(N)) \impliedby T(N) \leq c\cdot f(N):\quad c \in \R^+, N > N_0
$$
...
$$
T(N) = \Omega(f(N)) \impliedby T(N) \geq c\cdot f(N):\quad c \in \R^+, N > N_0
$$
...
$$
T(N) = o(f(N)) \impliedby T(N) < c \cdot f(N):\quad \forall c \in \R^+, N > N_0
$$
